            ...
            <div className="max-w-[1500px] mx-auto bg-white  rounded-xl overflow-hidden border border-slate-200">
                ...
                <div className="grid grid-cols-12 bg-amber-50/50">
                    ...
                    <div className="col-span-12 md:col-span-3 p-4 border-r border-b border-amber-200/50">
                        ...
                        <div className="relative">
                            <input type="text" className="w-full border border-amber-200 rounded-md p-2 pl-8 bg-white font-bold outline-none shadow-sm h-[38px] focus:ring-2 focus:ring-blue-400" placeholder="INV/0001" />
                    ...
                    {/* Financial Year */}
                    <div className="col-span-12 md:col-span-3 p-4 border-r border-b border-amber-200/50">
                        <label className="text-slate-500 font-bold uppercase block mb-1.5 text-[10px]">Fin Year</label>
                        <input type="text" className="w-full border border-amber-200 rounded-md p-2 bg-white font-bold outline-none shadow-sm h-[38px] text-center" placeholder="24-25" />
                    </div>
                    ...
                    <div className="col-span-12 md:col-span-3 p-4 border-r border-b border-amber-200/50">
                        ...
                        <div className="relative">
                            <select className="w-full border border-amber-200 rounded-md p-2 bg-white outline-none shadow-sm appearance-none font-bold h-[38px] pr-8">
                    ...
                    {/* Supply Type */}
                    <div className="col-span-12 md:col-span-3 p-4 border-b border-amber-200/50 bg-amber-50/30">
                        <label className="text-slate-500 font-bold uppercase block mb-1.5 text-[10px]">Sale Type</label>
                        <div className="relative">
                            <select className="w-full border border-amber-200 rounded-md p-2 bg-white outline-none shadow-sm appearance-none font-bold h-[38px] pr-8 text-blue-600">
                                <option>B2B (Regular)</option>
                                <option>B2C (Consumer)</option>
                            </select>
                            <ChevronDown size={12} className="absolute right-2.5 top-3 text-blue-400 pointer-events-none" />
                        </div>
                    </div>

                    <div className="col-span-12 md:col-span-3 p-4 border-b border-amber-200/50 bg-amber-50/30">
                        <label className="text-slate-500 font-bold uppercase block mb-1.5 text-[10px]">Invoice Type</label>
                        <div className="relative">
                            <select className="w-full border border-amber-200 rounded-md p-2 bg-white outline-none shadow-sm appearance-none font-bold h-[38px] pr-8 text-blue-600">
                                <option>B2B (Regular)</option>
                                <option>B2C (Consumer)</option>
                ...
                <div className="border-t border-amber-200">
                    ...
                    <div className="grid grid-cols-12 gap-0">
                        ...
                        <div className="col-span-12 md:col-span-2 p-4 border-r border-b border-amber-200/50 bg-slate-50/30">
                            <label className="text-slate-500 font-bold uppercase block mb-1.5 text-[10px]"> State ID</label>
