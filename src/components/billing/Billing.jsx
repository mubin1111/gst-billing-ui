  ...
  return (
    <div className="min-h-screen p-2 sm:p-4 md:p-3 text-[12px] font-sans text-slate-700">
      <div className="max-w-[1500px] mx-auto bg-white  rounded-xl overflow-hidden border border-slate-200">
        ...
        {/* STICKY ACTION BAR */}
        <div className="flex bg-blue-700 text-white p-3 gap-3 items-center sticky top-0 z-50">
          <div className="flex items-center gap-2 pr-4 border-r border-slate-600 mr-2">
            <div className="bg-blue-500 p-1.5 rounded-lg"><FileText size={18} /></div>
            <span className="font-bold text-sm tracking-tight">TAX INVOICE</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 bg-amber-50/50">
          ...
          <div className="col-span-3 p-4 border-r border-amber-200/50">
            <label className="text-slate-500 font-bold uppercase block mb-1.5">Invoice Date</label>
            <input type="date" className="w-full border border-amber-200 rounded-md p-2 bg-white focus:ring-2 focus:ring-blue-400 outline-none shadow-sm" defaultValue={new Date().toISOString().split('T')[0]} />
          </div>
          <div className="col-span-3 p-4 border-r border-amber-200/50">
                    ...
                    <td className="p-2 text-center min-w-[80px]">
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          className="p-1.5 text-red-900 hover:text-red-500 hover:bg-red-50 rounded transition-all group-hover:opacity-100"
                        >
                          <Trash2 size={18} />
                        </button>
                        {idx === items.length - 1 && (
